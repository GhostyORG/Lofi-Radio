...
client.on("message", async message => {
  ...
  if (message.content.match(prefixMention)) {
    ...
    let embed = new MessageEmbed()
      ...
      .setDescription(`Hey **${message.author.username},** It's me ${client.user.username}. Here are some my config: 
        ...
        ${dev} **Developer:** [Sparky!](https://discord.gg/4rztPDANgj)
        `)
      .setColor("#FF002B")
  ...
  if (command.premium) {
    ...
    let pree = new MessageEmbed()
      .setDescription(`**${pr} This server is not premium server.** \n${b}${dot} Use \`${prefix}premium Sparky!\` to get free 1 year premium.`)
    if (!guild) {
...
require('http').createServer((req, res) => res.end(`
 ...
 |• Author: Sparky!        |
 |-----------------------------------------|
 |• Server: https://discord.gg/ghostydev  |
 |-----------------------------------------|
 |• Youtube: { killerclaws1 }              |
 |-----------------------------------------|
